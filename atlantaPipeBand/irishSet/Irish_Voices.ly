        ...
        \time 4/4
			\bar ".|"
		        \set Timing.measurePosition = #(ly:make-moment -2 8) \grg a8. [ b16] |
                        ...
                        \dble e4 \gra e4 \grg f4 \grg e8. [c16] |
                        \grG a4 \dblc c8 b8 \grG a4 \grg a8. b16 |
                        \grG a4~a4 \wbirl a4 \grg c8 [ e8 ] |
		        \break
                        \dblf f4~f8 e8 \grg f4 \dblA A4 |
                        \hdblc c4~c8  b8 \grG a4 \grg c8. [ d16] |
                        \dble e4 c4 \dblA A4  c4 |
                        \set Timing.measurePosition = #(ly:make-moment 2 8) \grg b4~b4 \taor b4 | \bar "||"
                        \break
                        \set Timing.measurePosition = #(ly:make-moment 3 4) \grg c8 [ e8] |
                        \set Score.currentBarNumber = #9
                        \dblf f4~f8 e8 \grg f4 \dblA A4 |
                        \hdblc c4~c8  b8 \grG a4 \grg c8. [d16 ] |
                        \dble e4 c4 \dblA A4  c4 |
                        \grg b4~b4 \taor b4 \grg a8. [b16] |
                        \break
                        \grg c4 \grip c4 \dblc c4 \grg b8[ \grd c8] |
                        \dble e4 \gra e4 \grg f4 \grg e8. [c16] |
                        \grG a4 \dblc c8 b8 \grG a4 \grg a8. [b16] |
                        \set Timing.measurePosition = #(ly:make-moment 1 8) \grG a4~a4 \wbirl a4. |
                        \bar "|."
			\break				
}
...
WearingOfTheGreenAPB = 
{
 ...
 \repeat volta 2 {
		   ...
		   \set Timing.measurePosition = #(ly:make-moment -2 8) \grg a8. [b16] |
                ...
                {
                  \set Timing.measurePosition = #(ly:make-moment 6 8) A8. [g16] |
...
OldRusticBridgeAPB = 
{
  ...
  \bar ".|"
                        ...
                        \grg f4 \gre f8. [g16] \hdblf f4 \thrwd d8. ]c16] |
                        \dblb b4 \grg G8 [ \Gthrwd d8] \gre a4~a8. [\wbirl a16] |
                        \grg b4 \grg c8 [d8] \wslurd d4 \grg c8. [d16] |
                        \grg e4 \grG e8. [f16] \dble e4 \grg a8. [d16] |
                        \break
                        \grg f4 \gre f8. [g16] \hdblf f4 \thrwd d8. ]c16] |
                        \grg b4 \grg G8 [ \Gthrwd d8] \gre a4~a8. [\wbirl a16] |
                        \dblb b4 \grg e8 [g8] \hdblf f8. [e16]  \dblc c8 [\gre a8] |
                        \set Timing.measurePosition = #(ly:make-moment 1 4) \thrwd d4 \grg d8. [e16] \thrwd d4 | \bar "|.-b" 
                        \break	
                        \set Timing.measurePosition = #(ly:make-moment -1 4)   
                        \grg e8. [d16] |
                        \grg c4 \grip c8. [d16] \dble e4 \grg f8. [e16] |
                        \grg e4 \grg b8. [c16] \thrwd d4~ d8. [\grc d16] |
                        \dblc c4 \dblA A8 [c8] \grg e8. [d16]  \dblc c8 [\gre b8 ] |
                        \grg a4 \grg b4 \grip c4 \gre a8. [d16] |
			\break
                        \grg f4 \gre f8. [g16] \hdblf f4 \thrwd d8. ]c16] |
                        \grg b4 \grg G8 [ \Gthrwd d8] \gre a4~a8. [\wbirl a16] |
                        \dblb b4 \grg e8 [g8] \hdblf f8. [e16]  \dblc c8 [\gre a8] |
