...
OldRusticBridgeHarmonies = 
{
  ...
  \bar ".|"
                        ...
                        \grg f4 \gre f8. [g16] \hdblf f4 \thrwd d8. ]c16] |
                        \grg b4 \gre G8 [ \Gthrwd d8] \gre a4~a8 [\wbirl a8] |
                        \grg G4 \grd a8. [b16] \slurb b4 \grg a8. [b16] |
                        \grg c8 [a8] \grg c8. [d16] \dblc c4 \grg a8. [d16] |
                        \break
                        \grg f4 \gre f8. [e16] \thrwd d4 \grg f8. ]e16] |
                        \dblg g4 \grA g8 [f8] \grg e8 [d8] \grg c8 [a8] |
                        \grg G4 \grd a4 \grg d8. [c16]  \dblg g4 |
                        \set Timing.measurePosition = #(ly:make-moment 1 4) \grg f4 A8. [g16] \grA f4 | \bar "|.-b" 
                        \break	
                        %\set Timing.measurePosition = #(ly:make-moment -1 4)   
                        \partial 4 \grg e8. [d16] |
                        \grg c4 \grip c8. [d16] \dble e4 \grg f8. [e16] |
                        \dble e4 \grg b8. [c16] \thrwd d4~ d8 [\grc d8] |
                        \grg a4 \grd c8 [a8] \dblg g8. [f16]  \grg e8 [d8] |
                        \grg c4 d4 \grg e4 \gre a8. [d16] |
			\break
                        \grg f4 \gre f8. [e16] \thrwd d4 \grg f8. ]e16] |
                        \dblg g4 \grA g8 [f8] \grg e8 [d8] \grg c8 [a8] |
                        \grg G4 \grd a4 \grg d8. [c16]  \dblg g4 |
                        \set Timing.measurePosition = #(ly:make-moment 1 4) \grg f4 A8. [g16] \grA f4 | 
                        \bar "|." 
                        \break	
...
{               
			...
			%\set Timing.measurePosition = #(ly:make-moment -1 8) \grghide e8 |
                        \set Score.currentBarNumber = #8 \partial 8 \grghide e8 |
...
RowanTreeHarmonies = {
          \time 4/4
			...
			%\set Timing.measurePosition = #(ly:make-moment -1 8) \grg c8 |
                        \set Score.currentBarNumber = #8 \partial 8 \grg c8 |
                        \grG c4. f8  \grg f4.  e8 |
                        \dble e4 d4 \slurd d4 f4 |
                        \dblc c4. d8 \dbld d8 [ c8 ] \dblb b8 [ a8] |
                        \dbla a4. b16. [ a32 ] \dblG G4  \grg a8. [b16] |                       
                        \break
                        \hdblhide \grg a4. \wbirl a8 \dbla a4 \gre G4 |
                        \grg c8 [\gre a8] \grg b8 [\grd c8 ] \thrwd d4. c8 |
                        \dblc c8 \gre a4. \thrwd d4. e8 |
